...
USER_PERMISSIONS_FEATURES_BROWSER_EXTENSION = (
    os.getenv('USER_PERMISSIONS_FEATURES_BROWSER_EXTENSION', 'True').lower() == 'true'
)
...
DEFAULT_USER_PERMISSIONS = {
    ...
    'features': {
        ...
        'browser_extension': USER_PERMISSIONS_FEATURES_BROWSER_EXTENSION,
