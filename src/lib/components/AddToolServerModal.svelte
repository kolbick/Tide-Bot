				...
				>
					...
					{#if type === 'mcp'}
						...
						>
							...
							{$i18n.t(
								'MCP support is experimental and its specification changes often, which can lead to incompatibilities. Review a tool server carefully before making it available in Tide-Bot.'
							)}
						</div>
					{/if}
