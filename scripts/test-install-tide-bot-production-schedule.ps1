...
try {
	...
	$invalidStates = [ordered]@{
		...
		local_health_false = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; deployed_at_utc = '2026-08-25T00:00:00Z'; local_health = $false; public_health = $true; socketio_health = $true; oauth = @{ connection_present = $true; credential_decryptable = $true; credential_state = 'connected'; model_catalog_available = $true; model_count = 1 } }
		public_health_false = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; deployed_at_utc = '2026-08-25T00:00:00Z'; local_health = $true; public_health = $false; socketio_health = $true; oauth = @{ connection_present = $true; credential_decryptable = $true; credential_state = 'connected'; model_catalog_available = $true; model_count = 1 } }
		socketio_health_false = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; deployed_at_utc = '2026-08-25T00:00:00Z'; local_health = $true; public_health = $true; socketio_health = $false; oauth = @{ connection_present = $true; credential_decryptable = $true; credential_state = 'connected'; model_catalog_available = $true; model_count = 1 } }
		invalid_utc_timestamp = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; deployed_at_utc = '2026-08-25 00:00:00'; local_health = $true; public_health = $true; socketio_health = $true; oauth = @{ connection_present = $true; credential_decryptable = $true; credential_state = 'connected'; model_catalog_available = $true; model_count = 1 } }
		missing_utc_timestamp = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; local_health = $true; public_health = $true; socketio_health = $true; oauth = @{ connection_present = $true; credential_decryptable = $true; credential_state = 'connected'; model_catalog_available = $true; model_count = 1 } }
		malformed_oauth_field = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; deployed_at_utc = '2026-08-25T00:00:00Z'; local_health = $true; public_health = $true; socketio_health = $true; oauth = @{ connection_present = 'true'; credential_decryptable = $true; credential_state = 'connected'; model_catalog_available = $true; model_count = 1 } }
		disconnected_oauth = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; deployed_at_utc = '2026-08-25T00:00:00Z'; local_health = $true; public_health = $true; socketio_health = $true; oauth = @{ connection_present = $false; credential_decryptable = $true; credential_state = 'disconnected'; model_catalog_available = $true; model_count = 1 } }
		reconnect_required_oauth = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; deployed_at_utc = '2026-08-25T00:00:00Z'; local_health = $true; public_health = $true; socketio_health = $true; oauth = @{ connection_present = $true; credential_decryptable = $true; credential_state = 'reconnect_required'; model_catalog_available = $false; model_count = 0 } }
		not_decryptable_oauth = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; deployed_at_utc = '2026-08-25T00:00:00Z'; local_health = $true; public_health = $true; socketio_health = $true; oauth = @{ connection_present = $true; credential_decryptable = $false; credential_state = 'connected'; model_catalog_available = $true; model_count = 1 } }
		unavailable_catalog = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; deployed_at_utc = '2026-08-25T00:00:00Z'; local_health = $true; public_health = $true; socketio_health = $true; oauth = @{ connection_present = $true; credential_decryptable = $true; credential_state = 'connected'; model_catalog_available = $false; model_count = 1 } }
		empty_catalog = @{ schema_version = 1; commit = $commit; upstream_sha = $commit; image_id = 'sha256:tested-image'; deployed_at_utc = '2026-08-25T00:00:00Z'; local_health = $true; public_health = $true; socketio_health = $true; oauth = @{ connection_present = $true; credential_decryptable = $true; credential_state = 'connected'; model_catalog_available = $true; model_count = 0 } }
	}
	...
	Assert-True ($installerSource -match 'Get-TideBotDeployableCommit') 'Schedule does not use the updater exact-tag fetch and resolution contract.'
	Assert-True ($installerSource -match 'Test-TideBotCandidateIsOnMain') 'Schedule does not validate the marker against refreshed origin/main.'
	Assert-True ($installerSource -notmatch 'origin/tide-bot-deployable') 'Schedule still resolves the rejected remote-branch formulation.'
